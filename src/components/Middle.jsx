...
const Middle = () => {
  return (
    <div className='middle px-3 lg:px-40'>
      ...
      <img className=' bg-blue-400 rounded-t-2xl' src="/PayPalCharityUI/images/paypal-bg.png" />
      <img className='book-img' src="/PayPalCharityUI/images/book.png" />
      <div className='content md:flex mt-7'>
        <div className='col-1 py-5 pl-2'>
          <p className='text-md font-semibold'>Donate to PayPal Giving Funds</p>
          <h1 className='text-2xl font-semibold'>Figures of Speech Theatre</h1>
          <button className='Artbtn'>Arts & Culture</button>
          <div className='py-5'>
            <p className='text-md font-semibold'>Freeport, ME</p>
            <p className='text-md font-semibold'>EIN: 01-0432620</p>
          </div>
          <div className='flex'>
            <div className='icon'>
          ...
          <div className='para'>
            <p className='pt-5 font-semibold'>Figures of Speech Theatre creates and tours visionary works of performance forged at the intersection of poetry, music, sculpture and dance. The company has toured all over the world - from Sofia, Bulgaria to Tokyo, Japan, to Lima, Peru. Besides performing at venues such as the Kennedy Center, the Smithsonian Institution, and the New Victory Theatre on Broadway, the company retains a strong commitment to teaching and performing throughout its home state of Maine.</p>
            <p className=' font-medium pt-5'>Source: PayPal Giving and Charity profile</p>
            <p className='text-sm font-medium pt-5 text-slate-500'>The info in this profile is provided and managed by the charities themselves.</p>
          </div>
        </div>
        <div className='col-2 py-5 md:pl-10'>
          <div className="flex">
          ...
          <div className='pt-5 my-4 flex items-center'>
            ...
            <p className='pl-3 text-md font-semibold'>Share my name and email with this charity</p>
          </div>
